 ...
 * 
 * @author Not fully determined but assumed to be among Marie Van Den Bogaard,
...
public class Symbol {
     ...
     * 
     * May be any Object. In fact, for terminals with value it is indeed the value
     ...
     * This method has been modified from the provided class to provide the value of
     ...
     * @return a String containing the original string and spaces to reach at least
     *         length l.
     */
     ...
     * 
     * @return a string containing LaTeX code of a representation of the token's
     *         value and type.
     */
